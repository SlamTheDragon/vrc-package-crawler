...
This guide reviews discovery architectures, community curation models, and metadata patterns across the VRChat ecosystem.
...
- Japanese creators distribute character models and accessories primarily on BOOTH.pm[^1].
- Western creators sell avatars, clothing, and systems on Gumroad and Jinxxy[^2].
- Software developers publish open-source shaders, Udon libraries, and Editor tools on GitHub and VPM repositories[^3].
...
Discovering compatible assets is complex. A clothing mesh made for the "Kikyo" avatar base does not fit "Manuka" or "Shinano" without modification.
...
- **Respectful Politeness**: Runs request rates below 1.0 Hz with randomized intervals. Honors creator exclusion requests without friction.
...
Human curation yields high-precision metadata, but manual workflows scale slower than automated indexers.
